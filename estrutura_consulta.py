...
TIPOS_ALEITAMENTO = ["aleitamento materno exclusivo", "aleitamento materno predominante", "aleitamento misto", "fórmula infantil exclusiva", "leite de vaca", "alimentação complementar", "dieta habitual da família", "dieta seletiva/restritiva"]
